...
GameModel::GameModel()
{
    ...
    gameStatus = WAIT;
    m_pTimer = new QTimer;
    connect(m_pTimer,&QTimer::timeout,this,&GameModel::setRemainTime);//绑定定时器函数
}

GameModel::GameModel(GameType gameType)
{
...
void GameModel::initPVPGame()
{
    // 己方下为true,对方下位false
    playerFlag = qrand()%2;//随机确定白色方和黑色方
    emit SIG_playerSide(playerFlag);
    qDebug()<<playerFlag;
    remainMinP1 = 10;
    remainSecP1 = 0;
    remainMinP2 = 10;
